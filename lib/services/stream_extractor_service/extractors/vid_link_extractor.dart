...
class VidLinkExtractor implements BaseStreamExtractor {
  VidLinkExtractor() {
  ...
  final String _providerKey = "semo_vidlink";
  ...
  Future<MediaStream?> getStream(String? externalLink, StreamExtractorOptions options) async {
    try {
      ...
      final Map<String, dynamic>? stream = await extractStreamFromPageRequests(pageUri.toString());
      ...
      _logger.e("Error extracting stream in VidLinkExtractor", error: e, stackTrace: s);
    }
